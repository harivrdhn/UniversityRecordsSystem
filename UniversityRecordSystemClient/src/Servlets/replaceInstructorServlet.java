...
/**
 * Servlet implementation class replaceInstructorServlet
 */
public class replaceInstructorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public replaceInstructorServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String msg = proxy.replaceIstrucForCourse(instructorId, courseId);
