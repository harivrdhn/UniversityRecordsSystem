...
/**
 * Servlet implementation class displayAllInstructorsServlet
 */
public class displayAllInstructorsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public displayAllInstructorsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String courseList = proxy.displayAllInstructors();
